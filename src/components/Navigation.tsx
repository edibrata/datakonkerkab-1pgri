    ...
    return (
        <nav className="bg-white shadow-sm sticky top-0 z-50 border-b border-slate-200">
            <div className="max-w-[96%] mx-auto px-4 flex justify-between items-center h-14 md:h-16">
                <div className="flex items-center gap-2 md:gap-3 cursor-pointer group tooltip-container" onClick={() => onTabChange('beranda')}>
                    <img src="https://raw.githubusercontent.com/edibrata/image/main/Logo%20PGRI%20Official%20Full.png" alt="Logo PGRI" className="h-8 md:h-10 w-auto" />
                    <div className="flex flex-col">
                        <span className="font-bold text-base md:text-lg tracking-tight text-slate-900 leading-none">Konkerkab 1 <span className="text-red-600 uppercase">PGRI</span></span>
                        <span className="text-[7px] md:text-[8px] font-black text-slate-400 uppercase tracking-widest mt-0.5 leading-none">KABUPATEN PANDEGLANG</span>
                    </div>
                </div>
                ...
                <div className="flex items-center h-full">
                    ...
                    >
                        ...
                        <span className="tooltip-text" style={{width: 'auto'}}>Beranda</span>
                    </button>
                    <button 
                    ...
                    >
                        ...
                        <span className="tooltip-text" style={{width: 'auto'}}>Pendaftaran</span>
                    </button>
                    <button 
                    ...
                    >
                        ...
                        <span className="tooltip-text" style={{width: 'auto'}}>Database Admin</span>
                    </button>
                </div>
            </div>
        </nav>
